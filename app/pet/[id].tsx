...
const styles = StyleSheet.create({
  ...
  subTitle: { fontSize: TYPOGRAPHY.sizes.sm, fontWeight: '700', marginBottom: 8, marginTop: 12 },
  ...
  detailValue: { fontWeight: '600', flex: 1, fontSize: TYPOGRAPHY.sizes.sm },
  detailActions: { marginTop: 12 },
  rxInfoRow: { flexDirection: 'row', gap: 16, marginBottom: 12 },
  rxInfoCol: { flex: 1 },
  rxInfoSectionTitle: { fontSize: TYPOGRAPHY.sizes.xs, fontWeight: '700', letterSpacing: 0.5, marginBottom: 4, textTransform: 'uppercase' },
  rxInfoName: { fontWeight: '700', fontSize: TYPOGRAPHY.sizes.base, marginBottom: 2 },
  ...
  rxFieldHalf: { flex: 1 },
  rxFieldLabel: { fontSize: TYPOGRAPHY.sizes.sm, fontWeight: '700', marginBottom: 8 },
