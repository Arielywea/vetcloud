...
const styles = StyleSheet.create({
  ...
  alertText: { fontWeight: TYPOGRAPHY.weights.semibold, fontSize: TYPOGRAPHY.sizes.sm },
  ...
  itemName: { fontWeight: TYPOGRAPHY.weights.bold },
  itemCategory: { fontSize: TYPOGRAPHY.sizes.xs, marginTop: 2 },
  stockSection: { alignItems: 'flex-end', minWidth: 70 },
  stockNumber: { fontSize: TYPOGRAPHY.sizes.base, fontWeight: TYPOGRAPHY.weights.bold },
  stockUnit: { fontSize: TYPOGRAPHY.sizes.xs, fontWeight: TYPOGRAPHY.weights.regular },
  ...
  modalTitle: { fontWeight: TYPOGRAPHY.weights.bold, marginBottom: SPACING.lg },
  fieldLabel: { fontSize: TYPOGRAPHY.sizes.sm, fontWeight: TYPOGRAPHY.weights.semibold, marginBottom: SPACING.xs },
