...
const styles = StyleSheet.create({
  ...
  filterButtonText: { fontSize: TYPOGRAPHY.sizes.sm, fontWeight: TYPOGRAPHY.weights.semibold },
  ...
  categoryChip: { marginRight: 4, marginBottom: 4, paddingVertical: SPACING.sm, paddingHorizontal: SPACING.md, borderRadius: RADIUS.sm, borderWidth: 1, minHeight: 44, justifyContent: 'center' },
  ...
  diseaseName: { fontWeight: TYPOGRAPHY.weights.bold, flex: 1 },
  scientificName: { fontStyle: 'italic', marginTop: 2 },
  speciesRow: { flexDirection: 'row', alignItems: 'center', marginTop: SPACING.sm, gap: 6 },
  speciesText: { fontSize: TYPOGRAPHY.sizes.xs, fontWeight: TYPOGRAPHY.weights.semibold },
  signsContainer: { marginTop: SPACING.md },
  signsTitle: { fontWeight: TYPOGRAPHY.weights.semibold, marginBottom: 2 },
  ...
  sectionTitle: { fontSize: TYPOGRAPHY.sizes.base, fontWeight: TYPOGRAPHY.weights.bold, flex: 1 },
